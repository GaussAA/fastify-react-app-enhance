...
export const permissionService = {
  ...
  async hasPermission(
    ...
    try {
      ...
      logger.error('Error checking permission:', error as any);
      return false;
    }
  },
  ...
  async getUserPermissions(userId: number): Promise<string[]> {
    try {
      ...
      logger.error('Error getting user permissions:', error as any);
      return [];
    }
  },
  ...
  async getUserRoles(userId: number) {
    try {
      ...
      logger.error('Error getting user roles:', error as any);
      return [];
    }
  },
  ...
  async createPermission(data: PermissionData) {
    try {
      ...
      logger.error('Error creating permission:', error as any);
      throw error;
    }
  },
  ...
  async assignRoleToUser(data: UserRoleData) {
    try {
      ...
      logger.info(
        `Role assigned to user: ${userRole.user.email} -> ${userRole.role.name}`
      );
      return userRole;
    } catch (error) {
      logger.error('Error assigning role to user:', error as any);
      throw error;
    }
  },
  ...
  async removeRoleFromUser(userId: number, roleId: number) {
    try {
      ...
      logger.error('Error removing role from user:', error as any);
      throw error;
    }
  },
  ...
  async assignPermissionToRole(
    ...
    try {
      ...
      logger.info(
        `Permission assigned to role: ${rolePermission.role.name} -> ${rolePermission.permission.name}`
      );
      return rolePermission;
    } catch (error) {
      logger.error('Error assigning permission to role:', error as any);
      throw error;
    }
  },
  ...
  async getAllPermissions() {
    try {
      ...
      logger.error('Error getting all permissions:', error as any);
      throw error;
    }
  },
  ...
  async getPermissionById(id: number) {
    try {
      ...
      logger.error('Error getting permission by ID:', error as any);
      throw error;
    }
  },
  ...
  async updatePermission(
    ...
    try {
      ...
      logger.error('Error updating permission:', error as any);
      throw error;
    }
  },
  ...
  async deletePermission(id: number, deletedBy?: number) {
    try {
      ...
      logger.error('Error deleting permission:', error as any);
      throw error;
    }
  },
  ...
  async getPermissionsGroupedByResource() {
    try {
      ...
      logger.error(
        'Error getting permissions grouped by resource:',
        error as any
      );
      throw error;
    }
