...
export function ChatSettings({ onClose }: ChatSettingsProps) {
  const { config, updateConfig, models, loadModels } = useLLMStore();
        ...
        <CardContent className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
              {models.map(model => (
                <Badge
                  key={model.id}
                  variant={
                    localConfig.model === model.id ? 'default' : 'outline'
                  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-500">控制回复的最大长度</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-500">核采样参数，0-1之间</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-500">减少重复内容的可能性</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-500">鼓励模型谈论新话题</p>
            </div>
          </div>
