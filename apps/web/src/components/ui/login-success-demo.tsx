...
import { LoginSuccessTransition, LoginSuccessPage, LoginSuccessCard } from './login-success-transition';
import { useLoginSuccess } from '@/hooks/useLoginSuccess';
import { AnimatedButton } from './animated-button';

export function LoginSuccessDemo() {
    const [currentVariant, setCurrentVariant] = useState<'expand' | 'slide' | 'flip' | 'zoom'>('expand');
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900 p-8">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <h1 className="text-4xl font-bold text-white mb-4">登录成功转场动画演示</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    {variants.map((variant) => (
                        <motion.div
                            ...
                            whileTap={{ scale: 0.95 }}
                        >
                            <h3 className="text-lg font-semibold text-white mb-2">{variant.label}</h3>
                ...
                >
                    <div className="text-center max-w-md mx-auto p-8">
                        ...
                        <p className="text-white/80 mb-6">欢迎回来，正在为您准备个性化体验...</p>
                ...
                >
                    ...
                    <div className="space-y-3 text-white/80">
                        <p>• <strong>展开动画</strong>：3D翻转展开，适合页面级别的转场</p>
                        <p>• <strong>滑动动画</strong>：从下方滑入，适合卡片级别的转场</p>
                        <p>• <strong>翻转动画</strong>：X轴翻转，适合模态框级别的转场</p>
                        <p>• <strong>缩放动画</strong>：弹性缩放，适合按钮级别的转场</p>
                    </div>
                </motion.div>
