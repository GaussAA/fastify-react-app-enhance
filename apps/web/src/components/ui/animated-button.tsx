...
export function AnimatedButton({
  ...
  const animationConfig =
    accessibility.getAccessibleAnimation(buttonAnimations);
  ...
  return (
    <motion.button
      ...
      whileHover={!disabled && !loading ? motionProps.whileHover : undefined}
      whileTap={!disabled && !loading ? motionProps.whileTap : undefined}
...
export function LiquidGlassButton({
  ...
  const glassVariants = {
    ...
    'glass-primary':
      'bg-blue-600/40 backdrop-blur-xl border border-blue-500/50 hover:bg-blue-600/60 text-white font-semibold shadow-lg',
  };
