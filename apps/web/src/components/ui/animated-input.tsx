...
export function AnimatedInput({
  ...
  const variants = {
    ...
    glass:
      'bg-white/5 backdrop-blur-xl border border-white/20 focus:border-white/40',
  ...
  return (
    <div className="relative">
      ...
      <motion.input
        ...
        animate={
          isFocused ? formAnimations.inputFocus : formAnimations.inputBlur
        }
        transition={motionProps.transition}
        {...safeProps}
      />
      ...
      {error && (
        <motion.div
          ...
          animate={{ x: formAnimations.errorShake.x as unknown as number }}
          transition={motionProps.transition}
        />
      )}
    </div>
