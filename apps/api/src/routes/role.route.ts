...
export async function roleRoutes(app: FastifyInstance) {
    ...
    app.post(
        ...
        async (request, reply) => {
            try {
                const { name, displayName, description, permissions } = request.body as {
                    name: string;
                    displayName: string;
                    description?: string;
                    permissions?: string[];
    ...
    app.post(
        ...
        async (request, reply) => {
            try {
                ...
                await roleService.assignPermissionsToRole(id, permissions, assignedBy);
    ...
    app.delete(
        ...
        async (request, reply) => {
            try {
                const { id, permissionId } = request.params as { id: number; permissionId: number };
