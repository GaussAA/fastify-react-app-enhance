...
export const llmApiClient = {
    get chat() { return getLLMApiClientInstance().chat.bind(getLLMApiClientInstance()); },
    get chatStream() { return getLLMApiClientInstance().chatStream.bind(getLLMApiClientInstance()); },
    get listModels() { return getLLMApiClientInstance().listModels.bind(getLLMApiClientInstance()); },
    get getModel() { return getLLMApiClientInstance().getModel.bind(getLLMApiClientInstance()); },
    get healthCheck() { return getLLMApiClientInstance().healthCheck.bind(getLLMApiClientInstance()); },
    get healthCheckAll() { return getLLMApiClientInstance().healthCheckAll.bind(getLLMApiClientInstance()); },
    get getServiceStats() { return getLLMApiClientInstance().getServiceStats.bind(getLLMApiClientInstance()); },
    get getSupportedProviders() { return getLLMApiClientInstance().getSupportedProviders.bind(getLLMApiClientInstance()); }
};
